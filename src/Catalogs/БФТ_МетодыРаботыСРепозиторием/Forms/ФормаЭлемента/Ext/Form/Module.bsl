...
Процедура ПараметрыВыполненияЗначениеПараметраНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
  ...
  Элементы.ПараметрыВыполненияЗначениеПараметра.РежимВыбораИзСписка = Ложь;
	Элементы.ПараметрыВыполненияЗначениеПараметра.КнопкаВыбора = Истина;
	Элементы.ПараметрыВыполненияЗначениеПараметра.РедактированиеТекста = Ложь;
  ...
  ИначеЕсли ТекущиеДанные.РежимВводаПараметра = ПредопределенноеЗначение("Перечисление.БФТ_РежимВводаПараметра.ВыполнитьМетод") Тогда
    ...
    Элементы.ПараметрыВыполненияЗначениеПараметра.РежимВыбораИзСписка = Истина;
		Элементы.ПараметрыВыполненияЗначениеПараметра.КнопкаВыбора = Ложь;
  ИначеЕсли ТекущиеДанные.РежимВводаПараметра = ПредопределенноеЗначение("Перечисление.БФТ_РежимВводаПараметра.ВнешнийПараметр")  Тогда
    ...
    Элементы.ПараметрыВыполненияЗначениеПараметра.РежимВыбораИзСписка = Истина;
		Элементы.ПараметрыВыполненияЗначениеПараметра.КнопкаВыбора = Ложь;
	ИначеЕсли ТекущиеДанные.РежимВводаПараметра = ПредопределенноеЗначение("Перечисление.БФТ_РежимВводаПараметра.ЗначениеКонстанты")  Тогда
		СписокКонстант = ПолучитьСписокКонстант();
    Элементы.ПараметрыВыполненияЗначениеПараметра.СписокВыбора.ЗагрузитьЗначения(СписокКонстант);
    Элементы.ПараметрыВыполненияЗначениеПараметра.РежимВыбораИзСписка = Истина;
		Элементы.ПараметрыВыполненияЗначениеПараметра.КнопкаВыбора = Ложь;
	ИначеЕсли ТекущиеДанные.РежимВводаПараметра = ПредопределенноеЗначение("Перечисление.БФТ_РежимВводаПараметра.Произвольно")  Тогда	
		Элементы.ПараметрыВыполненияЗначениеПараметра.РедактированиеТекста = Истина;
  КонецЕсли;
...
&НаСервере
Функция ПолучитьСписокКонстант()
	Результат = Новый Массив();
	Для Каждого Константа Из Метаданные.Константы Цикл
		Результат.Добавить(Константа.Имя);
	КонецЦикла;
