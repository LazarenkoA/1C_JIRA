...
Процедура Разархивировать(ДД, Каталог, Пароль) Экспорт 
...
Функция Заархивировать(ИменаФайлов, Пароль) Экспорт  
	ВремФайлАрхив = ПолучитьИмяВременногоФайла();
...
Функция КоэффициентРазработки() Экспорт 
	Возврат 0.6;          
КонецФункции

Функция КоэффициентТестирования() Экспорт 
	Возврат 0.4;
КонецФункции
