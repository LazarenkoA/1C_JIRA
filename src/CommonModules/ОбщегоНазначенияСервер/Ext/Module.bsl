...
Функция ПолучитьКонфликтующиеДаты() Экспорт 
	...
	|
	|ИМЕЮЩИЕ
	|	МАКСИМУМ(Группировка.ОценкаВРабДнях + ЕСТЬNULL(ДанныеПрошлыхДат.ОценкаВРабДнях, 0)) > РАЗНОСТЬДАТ(&ТекДата, Группировка.ПлановаяДатаЗавершения, ЧАС) / 24
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|	ОтборЗадач.ОценкаВРабДнях КАК ОценкаВРабДнях,
	|	ИтоговаяГруппировка.РазностьКалендарныхДат КАК РазностьКалендарныхДат,
