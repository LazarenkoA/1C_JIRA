...
Процедура СборкаРасширений() Экспорт 
  ...
  ДанныеДляОсновногоПотока = Новый Структура("ТекущийШаг, ВыполненныеШаги", "", Новый Массив());
	...
	Попытка
		////////////////////////////////////////////////////////////////////////////////////////
		ДанныеДляОсновногоПотока.ТекущийШаг = "ОбновленияРасширенияИзРепозитория";
		...
		////////////////////////////////////////////////////////////////////////////////////////
		ДанныеДляОсновногоПотока.ТекущийШаг = "ОбновлениеРасширения";
		ОтправитьДанныеФЗ(ДанныеДляОсновногоПотока);
