...
Процедура ОбновитьБазу(АдресАрхива) Экспорт 
	...
	Попытка
		...
		Для Каждого Ф Из НайтиФайлы(ВремКаталог, "*.*") Цикл
			...
			ЗагрузитьФайлВБазу(Ф.ПолноеИмя, ИмяРасширения, "srv-bu1c-analitics\cpk-belgorod@Администратор");
		КонецЦикла;
