...
Функция ВыгрузитьНаСервере(НомерРевизии, АдресХранилища)
	...
	ФЗ = РеквизитФормыВЗначение("Объект").ВыгрузитьКонфигурацию(НомерРевизии, ПутьКСохраняемойКонфигурации, АдресХранилища, Объект.ВыгружатьФайлы, ВыгружатьЗащищеннуюКонфигурацию, ПутьКОбфускатору);  
