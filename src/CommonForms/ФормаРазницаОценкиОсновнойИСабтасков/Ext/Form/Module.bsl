...
Процедура Исправить(Команда)
	Для Каждого Стр Из СписокЗадач Цикл
		...
		ВзаимодействиеC_JIRA_КлиентСервер.УстановитьОценкуВыполненияИВремяЗадачи(Стр.Номер, Данные);
